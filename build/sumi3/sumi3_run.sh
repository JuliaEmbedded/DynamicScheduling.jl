...
vlog -work work +acc=blnr -sv -noincr -timescale 1ns/1ps sumi3_sim_tb.sv
...
vcom -2008 sumi3_graph.vhd

vopt -work work sumi3_sim_tb_top -o work_opt
vsim sumi3_sim_tb_top -do doit.tcl
