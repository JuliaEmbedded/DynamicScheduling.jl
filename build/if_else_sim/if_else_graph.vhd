...
-- File created: Thu May 21 17:54:53 2020
...
begin
	...
	phi_a0_clk <= clk;
	phi_a0_rst <= rst;
	mul_0_pValidArray_0 <= phi_a0_validArray_0;
	phi_a0_nReadyArray_0 <= mul_0_readyArray_0;
	mul_0_dataInArray_0 <= phi_a0_dataOutArray_0;

	phi_a1_clk <= clk;
	phi_a1_rst <= rst;
	mul_0_pValidArray_1 <= phi_a1_validArray_0;
	phi_a1_nReadyArray_0 <= mul_0_readyArray_1;
	mul_0_dataInArray_1 <= phi_a1_dataOutArray_0;
	...
	phi_a3_clk <= clk;
	phi_a3_rst <= rst;
	icmp_slt_1_pValidArray_1 <= phi_a3_validArray_0;
	phi_a3_nReadyArray_0 <= icmp_slt_1_readyArray_1;
	icmp_slt_1_dataInArray_1 <= phi_a3_dataOutArray_0;
	...
	phi_a5_clk <= clk;
	phi_a5_rst <= rst;
	mul_1_pValidArray_0 <= phi_a5_validArray_0;
	phi_a5_nReadyArray_0 <= mul_1_readyArray_0;
	mul_1_dataInArray_0 <= phi_a5_dataOutArray_0;

	phi_a6_clk <= clk;
	phi_a6_rst <= rst;
	mul_1_pValidArray_1 <= phi_a6_validArray_0;
	phi_a6_nReadyArray_0 <= mul_1_readyArray_1;
	mul_1_dataInArray_1 <= phi_a6_dataOutArray_0;
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	icmp_slt_1_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= icmp_slt_1_readyArray_0;
	icmp_slt_1_dataInArray_0 <= fork_4_dataOutArray_0;
