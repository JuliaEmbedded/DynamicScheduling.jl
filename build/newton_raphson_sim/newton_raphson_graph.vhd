...
-- File created: Thu May 21 17:54:14 2020
...
architecture behavioral of newton_raphson_graph is 
	...
	signal sink_39_dataInArray_0 : std_logic_vector(0 downto 0);
...
begin
	...
	branchC_3_clk <= clk;
	branchC_3_rst <= rst;
	sink_2_pValidArray_0 <= branchC_3_validArray_0;
	branchC_3_nReadyArray_0 <= sink_2_readyArray_0;
	sink_2_dataInArray_0 <= branchC_3_dataOutArray_0;
	phiMC_a1_pValidArray_0 <= branchC_3_validArray_1;
	branchC_3_nReadyArray_1 <= phiMC_a1_readyArray_0;
	phiMC_a1_dataInArray_0 <= branchC_3_dataOutArray_1;
	...
	sdiv_0_clk <= clk;
	sdiv_0_rst <= rst;
	add_7_pValidArray_0 <= sdiv_0_validArray_0;
	sdiv_0_nReadyArray_0 <= add_7_readyArray_0;
	add_7_dataInArray_0 <= sdiv_0_dataOutArray_0;
	...
	sink_4_dataInArray_0 <= branchC_6_dataOutArray_0;
	phiMC_a2_pValidArray_0 <= branchC_6_validArray_1;
	branchC_6_nReadyArray_1 <= phiMC_a2_readyArray_0;
	phiMC_a2_dataInArray_0 <= branchC_6_dataOutArray_1;

	sdiv_1_clk <= clk;
	sdiv_1_rst <= rst;
	sub_8_pValidArray_0 <= sdiv_1_validArray_0;
	sdiv_1_nReadyArray_0 <= sub_8_readyArray_0;
	sub_8_dataInArray_0 <= sdiv_1_dataOutArray_0;
	...
	sink_5_dataInArray_0 <= branchC_7_dataOutArray_0;
	phiMC_a0_pValidArray_1 <= branchC_7_validArray_1;
	branchC_7_nReadyArray_1 <= phiMC_a0_readyArray_1;
	phiMC_a0_dataInArray_1 <= branchC_7_dataOutArray_1;
	...
	cst_6_clk <= clk;
	cst_6_rst <= rst;
	add_1_pValidArray_0 <= cst_6_validArray_0;
	cst_6_nReadyArray_0 <= add_1_readyArray_0;
	add_1_dataInArray_0 <= cst_6_dataOutArray_0;
	...
	cst_13_clk <= clk;
	cst_13_rst <= rst;
	sdiv_1_pValidArray_0 <= cst_13_validArray_0;
	cst_13_nReadyArray_0 <= sdiv_1_readyArray_0;
	sdiv_1_dataInArray_0 <= cst_13_dataOutArray_0;
	...
	phi_a0_clk <= clk;
	phi_a0_rst <= rst;
	add_1_pValidArray_1 <= phi_a0_validArray_0;
	phi_a0_nReadyArray_0 <= add_1_readyArray_1;
	add_1_dataInArray_1 <= phi_a0_dataOutArray_0;
	...
	fork_4_clk <= clk;
	fork_4_rst <= rst;
	sub_2_pValidArray_0 <= fork_4_validArray_0;
	fork_4_nReadyArray_0 <= sub_2_readyArray_0;
	sub_2_dataInArray_0 <= fork_4_dataOutArray_0;
	...
	fork_5_clk <= clk;
	fork_5_rst <= rst;
	sub_4_pValidArray_0 <= fork_5_validArray_0;
	fork_5_nReadyArray_0 <= sub_4_readyArray_0;
	sub_4_dataInArray_0 <= fork_5_dataOutArray_0;
	...
	fork_15_clk <= clk;
	fork_15_rst <= rst;
	sub_2_pValidArray_1 <= fork_15_validArray_0;
	fork_15_nReadyArray_0 <= sub_2_readyArray_1;
	sub_2_dataInArray_1 <= fork_15_dataOutArray_0;
	sub_4_pValidArray_1 <= fork_15_validArray_1;
	fork_15_nReadyArray_1 <= sub_4_readyArray_1;
	sub_4_dataInArray_1 <= fork_15_dataOutArray_1;
	...
	fork_18_clk <= clk;
	fork_18_rst <= rst;
	sub_6_pValidArray_0 <= fork_18_validArray_0;
	fork_18_nReadyArray_0 <= sub_6_readyArray_0;
	sub_6_dataInArray_0 <= fork_18_dataOutArray_0;
	add_7_pValidArray_1 <= fork_18_validArray_1;
	fork_18_nReadyArray_1 <= add_7_readyArray_1;
	add_7_dataInArray_1 <= fork_18_dataOutArray_1;
	...
	fork_19_clk <= clk;
	fork_19_rst <= rst;
	sub_6_pValidArray_1 <= fork_19_validArray_0;
	fork_19_nReadyArray_0 <= sub_6_readyArray_1;
	sub_6_dataInArray_1 <= fork_19_dataOutArray_0;
	...
	fork_20_clk <= clk;
	fork_20_rst <= rst;
	sdiv_1_pValidArray_1 <= fork_20_validArray_0;
	fork_20_nReadyArray_0 <= sdiv_1_readyArray_1;
	sdiv_1_dataInArray_1 <= fork_20_dataOutArray_0;
	sub_8_pValidArray_1 <= fork_20_validArray_1;
	fork_20_nReadyArray_1 <= sub_8_readyArray_1;
	sub_8_dataInArray_1 <= fork_20_dataOutArray_1;
	...
	cst_2_dataInArray_0 <= "00000000000000000000000100101100";
...
icmp_slt_0: entity work.slt_op(arch) generic map (2,1,32,1)
port map (
	clk => icmp_slt_0_clk,
	rst => icmp_slt_0_rst,
...
icmp_slt_1: entity work.slt_op(arch) generic map (2,1,32,1)
port map (
	clk => icmp_slt_1_clk,
	rst => icmp_slt_1_rst,
...
icmp_sle_0: entity work.sle_op(arch) generic map (2,1,32,1)
port map (
	clk => icmp_sle_0_clk,
	rst => icmp_sle_0_rst,
...
sink_39: entity work.sink(arch) generic map (1,0,1,32)
port map (
	clk => sink_39_clk,
	rst => sink_39_rst,
