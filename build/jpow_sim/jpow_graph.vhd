...
-- File created: Sat May 23 02:07:59 2020
...
architecture behavioral of jpow_graph is 
	...
	signal buffC_3_clk : std_logic;
	signal buffC_3_rst : std_logic;
	signal buffC_3_dataInArray_0 : std_logic_vector(0 downto 0);
	signal buffC_3_pValidArray_0 : std_logic;
	signal buffC_3_readyArray_0 : std_logic;
	signal buffC_3_nReadyArray_0 : std_logic;
	signal buffC_3_validArray_0 : std_logic;
	signal buffC_3_dataOutArray_0 : std_logic_vector(0 downto 0);

	signal specBuff_clk : std_logic;
	signal specBuff_rst : std_logic;
	signal specBuff_dataInArray_0 : std_logic_vector(0 downto 0);
	signal specBuff_pValidArray_0 : std_logic;
	signal specBuff_readyArray_0 : std_logic;
	signal specBuff_nReadyArray_0 : std_logic;
	signal specBuff_validArray_0 : std_logic;
	signal specBuff_dataOutArray_0 : std_logic_vector(0 downto 0);
...
begin
	...
	phiM_a2_clk <= clk;
	phiM_a2_rst <= rst;
	buff_2_pValidArray_0 <= phiM_a2_validArray_0;
	phiM_a2_nReadyArray_0 <= buff_2_readyArray_0;
	buff_2_dataInArray_0 <= phiM_a2_dataOutArray_0;
	...
	phiMC_a0_clk <= clk;
	phiMC_a0_rst <= rst;
	buffC_3_pValidArray_0 <= phiMC_a0_validArray_0;
	phiMC_a0_nReadyArray_0 <= buffC_3_readyArray_0;
	buffC_3_dataInArray_0 <= phiMC_a0_dataOutArray_0;
	specBuff_pValidArray_0 <= phiMC_a0_validArray_1;
	phiMC_a0_nReadyArray_1 <= specBuff_readyArray_0;
	specBuff_dataInArray_0 <= phiMC_a0_dataOutArray_1;
	...
	buff_0_clk <= clk;
	buff_0_rst <= rst;
	branch_7_pValidArray_0 <= buff_0_validArray_0;
	buff_0_nReadyArray_0 <= branch_7_readyArray_0;
	branch_7_dataInArray_0 <= buff_0_dataOutArray_0;

	buff_1_clk <= clk;
	buff_1_rst <= rst;
	fork_0_pValidArray_0 <= buff_1_validArray_0;
	buff_1_nReadyArray_0 <= fork_0_readyArray_0;
	fork_0_dataInArray_0 <= buff_1_dataOutArray_0;

	buff_2_clk <= clk;
	buff_2_rst <= rst;
	branch_8_pValidArray_0 <= buff_2_validArray_0;
	buff_2_nReadyArray_0 <= branch_8_readyArray_0;
	branch_8_dataInArray_0 <= buff_2_dataOutArray_0;

	buffC_3_clk <= clk;
	buffC_3_rst <= rst;
	branchC_1_pValidArray_0 <= buffC_3_validArray_0;
	buffC_3_nReadyArray_0 <= branchC_1_readyArray_0;
	branchC_1_dataInArray_0 <= buffC_3_dataOutArray_0;

	specBuff_clk <= clk;
	specBuff_rst <= rst;
	forkMC_6_pValidArray_0 <= specBuff_validArray_0;
	specBuff_nReadyArray_0 <= forkMC_6_readyArray_0;
	forkMC_6_dataInArray_0 <= specBuff_dataOutArray_0;
...
buffC_3: entity work.elasticBuffer(arch) generic map (1,1,1,1)
port map (
	clk => buffC_3_clk,
	rst => buffC_3_rst,
	dataInArray(0) => buffC_3_dataInArray_0,
	pValidArray(0) => buffC_3_pValidArray_0,
	readyArray(0) => buffC_3_readyArray_0,
	nReadyArray(0) => buffC_3_nReadyArray_0,
	validArray(0) => buffC_3_validArray_0,
	dataOutArray(0) => buffC_3_dataOutArray_0
);

specBuff: entity work.elasticBuffer(arch) generic map (1,1,1,1)
port map (
	clk => specBuff_clk,
	rst => specBuff_rst,
	dataInArray(0) => specBuff_dataInArray_0,
	pValidArray(0) => specBuff_pValidArray_0,
	readyArray(0) => specBuff_readyArray_0,
	nReadyArray(0) => specBuff_nReadyArray_0,
	validArray(0) => specBuff_validArray_0,
	dataOutArray(0) => specBuff_dataOutArray_0
);
